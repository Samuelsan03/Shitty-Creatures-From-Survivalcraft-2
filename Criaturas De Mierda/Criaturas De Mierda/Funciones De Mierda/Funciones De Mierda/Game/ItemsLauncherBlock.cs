...
{
	// Token: 0x06000008 RID: 8 RVA: 0x00002919 File Offset: 0x00000B19
	public static int GetSpeedLevel(int data)
	{
		return data & 3;
	}

	// Token: 0x06000009 RID: 9 RVA: 0x0000291E File Offset: 0x00000B1E
	public static int GetRateLevel(int data)
	{
		return (data & 124) >> 2;
	}

	// Token: 0x0600000A RID: 10 RVA: 0x00002926 File Offset: 0x00000B26
	public static int GetSpreadLevel(int data)
	{
		return (data & 896) >> 7;
	}

	// Token: 0x0600000B RID: 11 RVA: 0x00002931 File Offset: 0x00000B31
	public static int GetFuel(int data)
	{
		return (data & 64512) >> 10;
	}

	// Token: 0x0600000C RID: 12 RVA: 0x0000293D File Offset: 0x00000B3D
	public static int SetSpeedLevel(int data, int level)
	{
		return (data & -4) | (level & 3);
	}

	// Token: 0x0600000D RID: 13 RVA: 0x00002947 File Offset: 0x00000B47
	public static int SetRateLevel(int data, int level)
	{
		return (data & -125) | (level << 2 & 124);
	}

	// Token: 0x0600000E RID: 14 RVA: 0x00002954 File Offset: 0x00000B54
	...
	// Token: 0x06000010 RID: 16 RVA: 0x00002996 File Offset: 0x00000B96
	public static int SetFuel(int data, int fuel)
	{
		return (data & -64513) | (fuel << 10 & 64512);
	}

	// Token: 0x06000011 RID: 17 RVA: 0x000029AA File Offset: 0x00000BAA
	public static int GetVirtualProjectileId(int data)
	{
		return data & 255;
	}

	// Token: 0x06000012 RID: 18 RVA: 0x000029B3 File Offset: 0x00000BB3
	public static int SetVirtualProjectileId(int data, int id)
	{
		return (data & -256) | (id & 255);
	}

	// Token: 0x06000013 RID: 19 RVA: 0x000029C4 File Offset: 0x00000BC4
	...
	// Token: 0x06000014 RID: 20 RVA: 0x00002A2B File Offset: 0x00000C2B
	public override void GenerateTerrainVertices(BlockGeometryGenerator generator, TerrainGeometry geometry, int value, int x, int y, int z)
	{
	}

	// Token: 0x06000015 RID: 21 RVA: 0x00002A2E File Offset: 0x00000C2E
