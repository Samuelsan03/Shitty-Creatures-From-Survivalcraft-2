...
namespace Game
{
	public class SCARBulletBlock : Block
	{
		...
		public const int Index = 369;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/SCAR ammunition", null);
	}
}