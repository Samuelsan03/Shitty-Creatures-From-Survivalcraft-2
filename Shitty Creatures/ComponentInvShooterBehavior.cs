            ...
            if (flag2)
            {
                switch (this.m_weaponInfo.Type)
                {
                    ...
                    case ComponentInvShooterBehavior.WeaponType.Musket:
                        ...
                        break;
                    case ComponentInvShooterBehavior.WeaponType.Cannon:
                        this.m_aimDuration = this.m_random.Float(1.2f, 1.8f);
                        break;
                    default:
                        this.m_aimDuration = this.m_random.Float(0.8f, 1.2f);
        ...
        private void PerformRangedFireAction()
        {
            ...
            if (flag2)
            {
                ...
                switch (this.m_weaponInfo.Type)
                {
                    ...
                    case ComponentInvShooterBehavior.WeaponType.Cannon:
                        {
                            bool flag9 = CannonBlock.GetLoadState(data) == CannonBlock.LoadState.Loaded && CannonBlock.GetHammerState(data);
                            bool flag10 = flag9;
                            if (flag10)
                            {
                                int cannonBallValue = Terrain.MakeBlockValue(CannonBallBlock.Index, 0, CannonBallBlock.SetCannonBallType(0, CannonBallBlock.CannonBallType.CannonBall));
                                Vector3 spread = new Vector3(this.m_random.Float(-0.02f, 0.02f), this.m_random.Float(-0.02f, 0.02f), 0f);
                                Vector3 velocity3 = (vector + spread) * 150f;
                                this.m_subsystemProjectiles.FireProjectile(cannonBallValue, eyePosition, velocity3, Vector3.Zero, this.m_componentCreature);
                                this.m_subsystemAudio.PlaySound("Audio/Items/ItemLauncher/Item Cannon Fire", 1f, this.m_random.Float(-0.1f, 0.1f), eyePosition, 15f, true);
                            }
                            num2 = Terrain.ReplaceData(slotValue, CannonBlock.SetLoadState(data, CannonBlock.LoadState.Empty));
                            num2 = Terrain.ReplaceData(num2, CannonBlock.SetHammerState(num2, false));
                            break;
                        }
                }
                bool flag23 = this.m_weaponInfo.Type != ComponentInvShooterBehavior.WeaponType.Throwable;
                bool flag24 = flag23;
                if (flag24)
                {
                    this.m_componentInventory.RemoveSlotItems(activeSlotIndex, 1);
        ...
        private void TryReloadWeapon(ComponentInvShooterBehavior.WeaponInfo weaponToReload)
        {
            ...
            if (flag2)
            {
                ...
                else
                {
                    ...
                    {
                        bool flag16 = weaponToReload.Type == ComponentInvShooterBehavior.WeaponType.Cannon;
                        bool flag17 = flag16;
                        if (flag17)
                        {
                            int num4 = this.FindItemSlotByContents(CannonBallBlock.Index);
                            bool flag18 = num4 != -1;
                            bool flag19 = flag18;
                            if (flag19)
                            {
                                int data4 = Terrain.ExtractData(weaponToReload.WeaponValue);
                                CannonBlock.LoadState loadState = CannonBlock.GetLoadState(data4);
                                bool hammerState = CannonBlock.GetHammerState(data4);
                                if (loadState != CannonBlock.LoadState.Loaded || !hammerState)
                                {
                                    int newData = CannonBlock.SetLoadState(data4, CannonBlock.LoadState.Loaded);
                                    newData = CannonBlock.SetCannonBallType(newData, CannonBallBlock.CannonBallType.CannonBall);
                                    newData = CannonBlock.SetHammerState(newData, true);
                                    int value2 = Terrain.ReplaceData(weaponToReload.WeaponValue, newData);
                                    this.m_componentInventory.RemoveSlotItems(weaponToReload.WeaponSlot, 1);
                                    this.m_componentInventory.AddSlotItems(weaponToReload.WeaponSlot, value2, 1);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                bool flag11 = block is CannonBlock;
                                result = (flag11 && CannonBlock.GetLoadState(data) == CannonBlock.LoadState.Loaded && CannonBlock.GetHammerState(data));
                            }
                        }
                    }
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            bool flag13 = weaponInfo.Type == ComponentInvShooterBehavior.WeaponType.Cannon;
                            bool flag14 = flag13;
                            if (flag14)
                            {
                                int blockIndex2 = CannonBallBlock.Index;
                                for (int j = 0; j < this.m_componentInventory.SlotsCount; j++)
                                {
                                    bool flag15 = j != weaponInfo.WeaponSlot && this.m_componentInventory.GetSlotCount(j) > 0;
                                    bool flag16 = flag15;
                                    bool flag17 = Terrain.ExtractContents(this.m_componentInventory.GetSlotValue(j)) == blockIndex2;
                                    if (flag16 && flag17)
                                    {
                                        return true;
                                    }
                ...
                if (flag2)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                bool flag9 = block is CannonBlock && CannonBlock.GetLoadState(data) == CannonBlock.LoadState.Loaded && CannonBlock.GetHammerState(data);
                                bool flag10 = !flag9;
                                if (flag10)
                                {
                                    goto IL_187;
                                ...
                                result = new ComponentInvShooterBehavior.WeaponInfo
                                {
                                    WeaponSlot = i,
                                    WeaponValue = slotValue,
                                    Type = ComponentInvShooterBehavior.WeaponType.Cannon
                                };
                            }
                        }
                    }
                ...
                if (flag2)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                bool flag9 = block is CannonBlock;
                                bool flag10 = !flag9;
                                if (flag10)
                                {
                                    goto IL_181;
