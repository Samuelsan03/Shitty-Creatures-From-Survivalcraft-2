...
namespace Game
{
	public class KABulletBlock : Block
	{
		...
		public const int Index = 390; // Siguiente índice disponible

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/38ACP", null);
	}
}