...
namespace Game
{
	public class GrozaBulletBlock : Block
	{
		...
		public const int Index = 458;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/Groza bullet", null);
	}
}