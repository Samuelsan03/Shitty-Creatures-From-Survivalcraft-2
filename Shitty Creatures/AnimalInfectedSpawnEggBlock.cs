...
namespace Game
{
	public class AnimalInfectedSpawnEggBlock : Block
	{
		public const int Index = 648; // Siguiente índice disponible
		...
		public override void Initialize()
		{
			...
			m_blockMesh.AppendModelMeshPart(
				...
				Color.Red // Color distintivo para huevos de animales
			);
			base.Initialize();
		}
