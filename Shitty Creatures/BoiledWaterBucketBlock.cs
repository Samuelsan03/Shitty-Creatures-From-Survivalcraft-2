...
namespace Game
{
	...
	public class BoiledWaterBucketBlock : BucketBlock
	{
		...
		public override void Initialize()
		{
			...
			this.m_standaloneBlockMesh.AppendModelMeshPart(model.FindMesh("Contents", true).MeshParts[0], boneAbsoluteTransform2 * Matrix.CreateRotationY(MathUtils.DegToRad(180f)) * Matrix.CreateTranslation(0f, -0.3f, 0f), false, false, false, false, new Color(104, 155, 255, 255));
