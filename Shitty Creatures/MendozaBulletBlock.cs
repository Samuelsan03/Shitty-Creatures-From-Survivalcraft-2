...
namespace Game
{
	public class MendozaBulletBlock : Block
	{
		...
		public const int Index = 485;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/Mendoza bullet", null);
	}
}