...
namespace Game
{
	public class M249BulletBlock : Block
	{
		...
		public const int Index = 380; // Nuevo índice

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/M249 ammunition", null);
	}
}