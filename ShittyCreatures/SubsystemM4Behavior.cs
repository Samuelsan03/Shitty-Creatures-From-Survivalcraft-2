...
namespace Game
{
	...
	public class SubsystemM4Behavior : SubsystemBlockBehavior
	{
		// Token: 0x17000015 RID: 21
		// (get) Token: 0x06000110 RID: 272 RVA: 0x0000B52C File Offset: 0x0000972C
		public override int[] HandledBlocks
		{
			get
			{
				return new int[]
				{
					BlocksManager.GetBlockIndex(typeof(M4Block), true, false)
				};
			}
		}

		// Token: 0x06000111 RID: 273 RVA: 0x0000B558 File Offset: 0x00009758
		...
		// Token: 0x06000112 RID: 274 RVA: 0x0000B5F4 File Offset: 0x000097F4
		public override bool OnAim(Ray3 aim, ComponentMiner componentMiner, AimState state)
		{
			...
			if (flag)
			{
				...
				if (flag2)
				{
					...
					int num2 = slotValue;
					bool flag3 = num == BlocksManager.GetBlockIndex(typeof(M4Block), true, false) && slotCount > 0;
					if (flag3)
					{
						double gameTime;
							...
							case AimState.InProgress:
								{
									...
									int bulletNum = M4Block.GetBulletNum(Terrain.ExtractData(slotValue));
									bool flag9 = bulletNum > 0;
									bool flag10 = this.m_subsystemTime.PeriodicGameTimeEvent(0.15, 0.0) && flag9;
									if (flag10)
									{
										...
										int num5 = 3;
										Vector3 vector5 = new Vector3(0.008f, 0.008f, 0.04f);
										for (int i = 0; i < num5; i++)
										{
											...
											this.m_subsystemProjectiles.FireProjectile(value, vector2, 300f * (vector3 + v3), Vector3.Zero, componentMiner.ComponentCreature);
										}
										this.m_subsystemAudio.PlaySound("Audio/Armas/M4 fuego", 1f, this.m_random.Float(-0.1f, 0.1f), componentMiner.ComponentCreature.ComponentCreatureModel.EyePosition, 10f, true);
										...
										num2 = Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(M4Block), true, false), 0, M4Block.SetBulletNum(bulletNum2));
									...
									else
									{
										...
										if (flag13)
										{
											...
											{
												string bulletName = LanguageControl.Get("Blocks", "M4Bullet:0", "DisplayName");
												componentPlayer2.ComponentGui.DisplaySmallMessage(LanguageControl.Get("Messages", "NeedAmmo").Replace("{0}", bulletName), Color.White, true, false);
											}
										}
									}
									break;
		...
		// Token: 0x06000113 RID: 275 RVA: 0x0000BE18 File Offset: 0x0000A018
		public override int GetProcessInventoryItemCapacity(IInventory inventory, int slotIndex, int value)
		{
			bool flag = value == BlocksManager.GetBlockIndex(typeof(M4Bullet), true, false) && M4Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex))) < 22;
			bool flag2 = flag;
			int result;
			if (flag2)
			{
		...
		// Token: 0x06000114 RID: 276 RVA: 0x0000BE68 File Offset: 0x0000A068
		public override void ProcessInventoryItem(IInventory inventory, int slotIndex, int value, int count, int processCount, out int processedValue, out int processedCount)
		{
			processedValue = value;
			processedCount = count;
			int bulletNum = M4Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex)));
			bool flag = bulletNum < 22;
			bool flag2 = flag;
			if (flag2)
			{
				processedValue = 0;
				...
				inventory.AddSlotItems(slotIndex, Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(M4Block), true, false), 0, M4Block.SetBulletNum(22)), 1);

				// Reproducir sonido de recarga - buscar al jugador a través de SubsystemPlayers
