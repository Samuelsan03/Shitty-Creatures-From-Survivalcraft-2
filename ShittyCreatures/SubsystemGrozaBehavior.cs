...
namespace Game
{
	public class SubsystemGrozaBehavior : SubsystemBlockBehavior
	{
		public override int[] HandledBlocks
		{
			get
			{
				return new int[]
				{
					BlocksManager.GetBlockIndex(typeof(GrozaBlock), true, false)
				};
			}
		}
		...
		public override bool OnAim(Ray3 aim, ComponentMiner componentMiner, AimState state)
		{
			...
			if (flag)
			{
				...
				if (flag2)
				{
					...
					int num2 = slotValue;
					bool flag3 = num == BlocksManager.GetBlockIndex(typeof(GrozaBlock), true, false) && slotCount > 0;
					if (flag3)
					{
						double gameTime;
							...
							case AimState.InProgress:
								{
									...
									int bulletNum = GrozaBlock.GetBulletNum(Terrain.ExtractData(slotValue));
									...
									if (flag10)
									{
										...
										num2 = Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(GrozaBlock), true, false), 0, GrozaBlock.SetBulletNum(bulletNum2));
									...
									else
									{
										...
										if (flag13)
										{
											...
											{
												string bulletName = LanguageControl.Get("Blocks", "GrozaBulletBlock:0", "DisplayName");
		...
		{
			bool flag = value == BlocksManager.GetBlockIndex(typeof(GrozaBulletBlock), true, false) && GrozaBlock.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex))) < 30;
			bool flag2 = flag;
			int result;
			if (flag2)
			{
		...
		public override void ProcessInventoryItem(IInventory inventory, int slotIndex, int value, int count, int processCount, out int processedValue, out int processedCount)
		{
			...
			int bulletNum = GrozaBlock.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex)));
			...
			if (flag2)
			{
				...
				inventory.AddSlotItems(slotIndex, Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(GrozaBlock), true, false), 0, GrozaBlock.SetBulletNum(30)), 1);
