...
namespace Game
{
	public class GunsTradeWidget : CanvasWidget
	{
		...
		public GunsTradeWidget(IInventory playerInventory, ComponentTrader trader, ComponentPlayer player)
		{
			m_trader = trader;
			m_player = player;
			...
			XElement node = ContentManager.Get<XElement>("Widgets/GunsTradeWidget");
			...
			// Configurar estilo del temporizador (naranja, centrado)
			m_timerLabel.FontScale = 0.8f;
			m_timerLabel.Color = new Color(255, 140, 0); // Naranja
		...
		public override void Update()
		{
			...
			// Actualizar temporizador: solo tiempo en formato MM:SS, color naranja
