...
namespace Game
{
	public class SubsystemNewG3Behavior : SubsystemBlockBehavior
	{
		public override int[] HandledBlocks
		{
			get
			{
				return new int[]
				{
					BlocksManager.GetBlockIndex(typeof(NewG3Block), true, false)
				};
			}
		}
		...
		public override bool OnAim(Ray3 aim, ComponentMiner componentMiner, AimState state)
		{
			...
			if (flag)
			{
				...
				if (flag2)
				{
					...
					int num2 = slotValue;
					bool flag3 = num == BlocksManager.GetBlockIndex(typeof(NewG3Block), true, false) && slotCount > 0;
					if (flag3)
					{
						double gameTime;
							...
							case AimState.InProgress:
								{
									...
									int bulletNum = NewG3Block.GetBulletNum(Terrain.ExtractData(slotValue));
									...
									if (flag10)
									{
										...
										this.m_subsystemAudio.PlaySound("Audio/Armas/G3 fuego", 1f, this.m_random.Float(-0.1f, 0.1f), componentMiner.ComponentCreature.ComponentCreatureModel.EyePosition, 10f, true);
										...
										num2 = Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(NewG3Block), true, false), 0, NewG3Block.SetBulletNum(bulletNum2));
									...
									else
									{
										...
										if (flag13)
										{
											...
											{
												string bulletName = LanguageControl.Get("Blocks", "NewG3Bullet:0", "DisplayName");
		...
		{
			bool flag = value == BlocksManager.GetBlockIndex(typeof(NewG3Bullet), true, false) && NewG3Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex))) < 30;
			bool flag2 = flag;
			int result;
			if (flag2)
			{
		...
		public override void ProcessInventoryItem(IInventory inventory, int slotIndex, int value, int count, int processCount, out int processedValue, out int processedCount)
		{
			...
			int bulletNum = NewG3Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex)));
			...
			if (flag2)
			{
				...
				inventory.AddSlotItems(slotIndex, Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(NewG3Block), true, false), 0, NewG3Block.SetBulletNum(30)), 1);
