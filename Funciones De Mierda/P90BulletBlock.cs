...
namespace Game
{
	public class P90BulletBlock : Block
	{
		...
		{
			BlocksManager.DrawMeshBlock(primitivesRenderer, this.m_standaloneBlockMesh, this.texture, color, 1.7f * size, ref matrix, environmentData);
		}

		public const int Index = 367;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/P90 amunition", null);
	}
}