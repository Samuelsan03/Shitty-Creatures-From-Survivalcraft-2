...
namespace Game
{
	public class SubsystemBoiledWaterBucketBlockBehavior : SubsystemBlockBehavior
	{
		public override int[] HandledBlocks => new int[] { BoiledWaterBlock.Index };
		...
		public override bool OnUse(Ray3 ray, ComponentMiner componentMiner)
		{
			...
			// Intentar beber. DrinkWater ya maneja el caso de sed llena.
			if (!thirst.DrinkWater(1f)) return false;
