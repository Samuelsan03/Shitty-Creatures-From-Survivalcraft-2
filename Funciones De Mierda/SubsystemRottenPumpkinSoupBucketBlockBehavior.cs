...
namespace Game
{
	public class SubsystemRottenPumpkinSoupBucketBlockBehavior : SubsystemBlockBehavior
	{
		public override int[] HandledBlocks => new int[] { RottenPumpkinSoupBucketBlock.Index };
