...
namespace Game
{
	public class AA12Block : Block
	{
		public override void Initialize()
		{
			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/AA12", null);
		...
		{
			return (data >> 4) & 31; // 5 bits para 0-31 (0-20 balas, capacidad del cargador real)
		}

		public static int SetBulletNum(int data, int bulletNum)
		{
			bulletNum = MathUtils.Clamp(bulletNum, 0, 20);
			return (data & ~496) | ((bulletNum & 31) << 4);
		}

		public const int Index = 377;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/AA12", null);
	}
}