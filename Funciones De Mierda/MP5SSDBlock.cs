...
namespace Game
{
	public class MP5SSDBlock : Block
	{
		...
		{
			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/MP5SSD Gun", null);
		...
		public const int Index = 383;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/MP5SSD", null);
	}
}