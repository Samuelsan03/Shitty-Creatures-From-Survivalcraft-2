...
namespace Armas
{
	...
	public class SubsystemMac10Behavior : SubsystemBlockBehavior
	{
		// Token: 0x17000016 RID: 22
		// (get) Token: 0x06000116 RID: 278 RVA: 0x0000BEF8 File Offset: 0x0000A0F8
		public override int[] HandledBlocks
		{
			get
			{
				return new int[]
				{
					BlocksManager.GetBlockIndex(typeof(Mac10Block), true, false)
				};
			}
		}

		// Token: 0x06000117 RID: 279 RVA: 0x0000BF24 File Offset: 0x0000A124
		...
		// Token: 0x06000118 RID: 280 RVA: 0x0000BFC0 File Offset: 0x0000A1C0
		public override bool OnAim(Ray3 aim, ComponentMiner componentMiner, AimState state)
		{
			...
			if (flag)
			{
				...
				if (flag2)
				{
					...
					int num2 = slotValue;
					bool flag3 = num == BlocksManager.GetBlockIndex(typeof(Mac10Block), true, false) && slotCount > 0;
					if (flag3)
					{
						double gameTime;
							...
							case AimState.InProgress:
								{
									...
									int bulletNum = Mac10Block.GetBulletNum(Terrain.ExtractData(slotValue));
									bool flag9 = bulletNum > 0;
									bool flag10 = this.m_subsystemTime.PeriodicGameTimeEvent(0.1, 0.0) && flag9;
									if (flag10)
									{
										...
										int num5 = 1;
										Vector3 vector5 = new Vector3(0.012f, 0.012f, 0.035f);
										...
										componentMiner.ComponentCreature.ComponentBody.ApplyImpulse(-0.05f * vector3);
		...
		// Token: 0x06000119 RID: 281 RVA: 0x0000C7E4 File Offset: 0x0000A9E4
		public override int GetProcessInventoryItemCapacity(IInventory inventory, int slotIndex, int value)
		{
			bool flag = value == BlocksManager.GetBlockIndex(typeof(Mac10Bullet), true, false) && Mac10Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex))) < 30;
			bool flag2 = flag;
			int result;
			if (flag2)
			{
		...
		// Token: 0x0600011A RID: 282 RVA: 0x0000C834 File Offset: 0x0000AA34
		public override void ProcessInventoryItem(IInventory inventory, int slotIndex, int value, int count, int processCount, out int processedValue, out int processedCount)
		{
			processedValue = value;
			processedCount = count;
			int bulletNum = Mac10Block.GetBulletNum(Terrain.ExtractData(inventory.GetSlotValue(slotIndex)));
			...
			if (flag2)
			{
				...
				inventory.AddSlotItems(slotIndex, Terrain.MakeBlockValue(BlocksManager.GetBlockIndex(typeof(Mac10Block), true, false), 0, Mac10Block.SetBulletNum(30)), 1);
			}
		}
