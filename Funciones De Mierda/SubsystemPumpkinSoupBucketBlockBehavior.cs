...
namespace Game
{
	public class SubsystemPumpkinSoupBucketBlockBehavior : SubsystemBlockBehavior
	{
		public override int[] HandledBlocks => new int[] { PumpkinSoupBucketBlock.Index };
		...
		public override bool OnUse(Ray3 ray, ComponentMiner componentMiner)
		{
			...
			{
				if (thirst != null && !thirst.Drink(0.4f))
					return false;
			}
