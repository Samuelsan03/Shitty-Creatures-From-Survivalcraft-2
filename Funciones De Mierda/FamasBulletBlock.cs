...
namespace Game
{
	public class FamasBulletBlock : Block
	{
		...
		public const int Index = 373;

		private BlockMesh m_standaloneBlockMesh = new BlockMesh();

		public Texture2D texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/FAMAS Amunition", null);
	}
}
