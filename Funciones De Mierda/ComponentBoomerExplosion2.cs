...
namespace Game
{
	public class ComponentBoomerExplosion2 : Component, IUpdateable
	{
		// ===== CONFIGURACIÓN =====
		...
		public override void Save(ValuesDictionary valuesDictionary, EntityToIdMap entityToIdMap)
		{
			...
			valuesDictionary.SetValue("FireSpreadChance", FireSpreadChance);
			valuesDictionary.SetValue("FireDuration", FireDuration);
		}
